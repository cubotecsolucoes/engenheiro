...
<body id="page-top" class="index">
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-custom navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">Web Site de Exemplo</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="#<?php echo($menu['link']); ?>"><?php echo($menu['menu']); ?></a>
                    </li>
                    <?php endforeach; ?>
                </ul>
            </div>
    ...
    <section id="services">
        <div class="container">
            ...
            <div class="row text-center">
                ...
                <div class="col-md-<?php echo(12/count($services)); ?>">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary"></i>
                        <i class="fa fa-<?php echo($service['icon']); ?> fa-stack-1x fa-inverse"></i>
                    </span>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal<?php echo($index+1); ?>" class="portfolio-link" data-toggle="modal">
                        <div class="portfolio-hover">
                            <div class="portfolio-hover-content">
                                <i class="fa fa-plus fa-3x"></i>
                            </div>
                        </div>
                        <img src="<?php echo(base_url('assets/img/portfolio/'.$portfolio['img'])); ?>" class="img-responsive" alt="">
                    </a>
                    <div class="portfolio-caption">
                        <h4><?php echo($portfolio['title']); ?></h4>
                        <p class="text-muted"><?php echo($portfolio['subtitle']); ?></p>
                    </div>
                </div>
                <?php endforeach; ?>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="timeline">
                        ...
                        <li class="<?php echo !($index % 2) ? "" : "timeline-inverted"; ?>">
                            <div class="timeline-image">
                                <img class="img-circle img-responsive" src="<?php echo(base_url('assets/img/about/'.$about['img'])); ?>" alt="">
                            </div>
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4><?php echo($about['year']); ?></h4>
    ...
    <section id="team" class="bg-light-gray">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">A nossa equipe</h2>
                    <h3 class="section-subheading text-muted">Lorem ipsum dolor sit amet consectetur.</h3>
                </div>
            </div>
            <div class="row">
                <?php foreach ($teams as $index => $team): ?>
                <div class="col-sm-<?php echo(12/count($teams)); ?>">
                    <div class="team-member">
                        <img src="<?php echo(base_url('assets/img/team/'.$team['img'])); ?>" class="img-responsive img-circle" alt="">
                        <h4><?php echo($team['name']); ?></h4>
                        <p class="text-muted"><?php echo($team['office']); ?></p>
                        <ul class="list-inline social-buttons">
                            <li><a href="<?php echo($team['twitter']); ?>" target="_blank"><i class="fa fa-twitter"></i></a>
                            </li>
                            <li><a href="<?php echo($team['face']); ?>" target="_blank"><i class="fa fa-facebook"></i></a>
                            </li>
                            <li><a href="<?php echo($team['linkedin']); ?>" target="_blank"><i class="fa fa-linkedin"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
